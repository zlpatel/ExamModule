...
<body>
	...
	<form:form method="GET">
		...
		<center><h4>Statistics for Additional questions answered by the
			${studentName}</h4></center>
					...
					<canvas id="latexCanvas" width="0" height="0"
						style="border:0px solid #000000;"></canvas></td> --%>
							...
							<td class="text-center"><fmt:formatDate
									value="${additionalQuestionsRecord.startTime}" pattern="HH:mm:ss" /></td>
							<td class="text-center"><fmt:formatDate
									value="${additionalQuestionsRecord.attemptTime}"
									pattern="HH:mm:ss" /></td>
